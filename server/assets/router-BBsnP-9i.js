...
import { createLink, useMatchRoute, createRootRoute, Outlet, HeadContent, Scripts, createFileRoute, lazyRouteComponent, createRouter } from "@tanstack/react-router";
import { TanStackRouterDevtools } from "@tanstack/react-router-devtools";
import { Global, ThemeContext as ThemeContext$1, keyframes, css, CacheProvider } from "@emotion/react";
import createCache from "@emotion/cache";
import * as React from "react";
import React__default from "react";
import { isValidElementType, Memo, ForwardRef, isFragment } from "react-is";
...
const List$2 = /* @__PURE__ */ React.forwardRef(function List(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiList"
  });
...
process.env.NODE_ENV !== "production" ? List$2.propTypes = {
  // ┌────────────────────────────── Warning ──────────────────────────────┐
  // │ These PropTypes are generated from the TypeScript type definitions. │
  // │    To update them, edit the d.ts file and run `pnpm proptypes`.     │
  // └─────────────────────────────────────────────────────────────────────┘
...
const KeyboardArrowRight$1 = createSvgIcon(/* @__PURE__ */ jsx("path", {
...
const TabScrollButton = /* @__PURE__ */ React.forwardRef(function TabScrollButton2(inProps, ref) {
  ...
  const EndButtonIcon = slots.EndScrollButtonIcon ?? KeyboardArrowRight$1;
...
const Tabs = /* @__PURE__ */ React.forwardRef(function Tabs2(inProps, ref) {
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollbarSizeListener = scrollable ? /* @__PURE__ */ jsx(ScrollbarSlot, {
      ...scrollbarSlotProps,
      onChange: handleScrollbarSizeChange
    }) : null;
    const scrollButtonsActive = displayStartScroll || displayEndScroll;
    const showScrollButtons = scrollable && (scrollButtons === "auto" && scrollButtonsActive || scrollButtons === true);
    conditionalElements2.scrollButtonStart = showScrollButtons ? /* @__PURE__ */ jsx(ScrollButtonsSlot, {
      direction: isRtl ? "right" : "left",
      onClick: handleStartScrollClick,
      disabled: !displayStartScroll,
      ...scrollButtonSlotProps
    }) : null;
    conditionalElements2.scrollButtonEnd = showScrollButtons ? /* @__PURE__ */ jsx(ScrollButtonsSlot, {
...
const fontsourceVariableRobotoCss = "/naofix_widget_poc/assets/index-CTY3ID-e.css";
...
const MUILinkComponent = React__default.forwardRef(
  (props, ref) => /* @__PURE__ */ jsx(Link, { ref, ...props })
);
const CreatedLinkComponent = createLink(MUILinkComponent);
const CustomLink = (props) => {
  return /* @__PURE__ */ jsx(CreatedLinkComponent, { preload: "intent", ...props });
};
const AccessTimeOutlined = createSvgIcon(/* @__PURE__ */ jsx("path", {
...
const Brightness4 = createSvgIcon(/* @__PURE__ */ jsx("path", {
...
const Brightness7 = createSvgIcon(/* @__PURE__ */ jsx("path", {
...
const Build = createSvgIcon(/* @__PURE__ */ jsx("path", {
...
const CalendarMonth = createSvgIcon(/* @__PURE__ */ jsx("path", {
...
const CalendarMonthOutlined = createSvgIcon(/* @__PURE__ */ jsx("path", {
...
const CheckBoxOutlined = createSvgIcon(/* @__PURE__ */ jsx("path", {
...
const EmailOutlined = createSvgIcon(/* @__PURE__ */ jsx("path", {
...
const List2 = createSvgIcon(/* @__PURE__ */ jsx("path", {
  d: "M3 13h2v-2H3zm0 4h2v-2H3zm0-8h2V7H3zm4 4h14v-2H7zm0 4h14v-2H7zM7 7v2h14V7z"
}), "List");
const SaveOutlined = createSvgIcon(/* @__PURE__ */ jsx("path", {
...
const Visibility = createSvgIcon(/* @__PURE__ */ jsx("path", {
...
const useThemeMode = () => useStore(themeStore);
...
const layoutStore = new Store(initialLayoutState);
const getcurrentView = () => layoutStore.state.currentView;
...
const updateLayoutRows = (rows) => {
  const layout = getcurrentView();
  if (!layout) return;
  const newRowsData = Array.from({ length: rows }, (_, i) => {
...
const updateLayoutColumns = (rowIndex, columns) => {
  const layout = getcurrentView();
  if (!layout) return;
  ...
  const newRows = layout.rows.map(
    (r, idx) => idx === rowIndex ? { ...r, columns: newColumnData } : r
  );
  layoutStore.setState({
    ...layoutStore.state,
...
const updateColumnWidth = (rowIndex, columnIndex, width2) => {
  const layout = getcurrentView();
  if (!layout) return;
  const row = layout.rows[rowIndex];
  if (!row) return;
  const newColumnData = row.columns.map(
    (c, idx) => idx === columnIndex ? { ...c, width: width2 } : c
  );
  const newRows = layout.rows.map(
    (r, idx) => idx === rowIndex ? { ...r, columns: newColumnData } : r
  );
...
const updateLayoutModule = (module) => {
  const layout = getcurrentView();
  if (!layout) return;
  layoutStore.setState({
    ...layoutStore.state,
...
const updateLayoutViewType = (view_type) => {
  const layout = getcurrentView();
  if (!layout) return;
  layoutStore.setState({
    ...layoutStore.state,
...
const useLayoutStore = () => useStore(layoutStore);
const useDrawer = () => useStore(layoutStore, (state) => state.drawer.isOpen);
const usePreviewMode = () => useStore(layoutStore, (state) => state.previewMode);
const modules = [
  {
    id: "messaging_module",
    name: "messaging",
...
const modalsStore = new Store(initialModalsState);
const openModal = (modalId, detail) => {
...
const toggleModal = (modalId, detail) => {
...
const useModal = (modalId) => {
  ...
  return {
    isOpen: modal.isOpen,
    detail: modal.detail,
    open: (detail) => openModal(modalId, detail),
    close: () => closeModal(modalId),
    toggle: (detail) => toggleModal(modalId, detail)
  };
};
...
const CreatorPageToolComponent = () => {
  const [currentModuleMenuAnchorEl, setCurrentModuleMenuAnchorEl] = React__default.useState(null);
  const currentModuleMenuOpen = Boolean(currentModuleMenuAnchorEl);
  const handleModuleMenuButtonClick = (event) => {
    setCurrentModuleMenuAnchorEl(event.currentTarget);
  };
  const handleModuleMenuButtonClose = () => {
    setCurrentModuleMenuAnchorEl(null);
  };
  const [rowMenuAnchorEl, setRowMenuAnchorEl] = React__default.useState(null);
  const rowMenuOpen = Boolean(rowMenuAnchorEl);
  const handleRowsMenuButtonClick = (event) => {
    setRowMenuAnchorEl(event.currentTarget);
  };
  const handleRowsMenuButtonClose = () => {
    setRowMenuAnchorEl(null);
  };
  const [viewTypeMenuAnchorEl, setViewTypeMenuAnchorEl] = React__default.useState(null);
  const viewTypeMenuOpen = Boolean(viewTypeMenuAnchorEl);
  const handleViewTypeMenuButtonClick = (event) => {
  ...
  return /* @__PURE__ */ jsxs(Stack, { direction: "row", alignItems: "center", spacing: 1, children: [
    ...
    /* @__PURE__ */ jsxs(Box, { children: [
      /* @__PURE__ */ jsx(
        Chip,
        {
          ...
          size: "small",
          "aria-controls": currentModuleMenuOpen ? "basic-menu" : void 0,
          "aria-haspopup": "true",
          "aria-expanded": currentModuleMenuOpen ? "true" : void 0,
          onClick: handleModuleMenuButtonClick,
          icon: /* @__PURE__ */ jsx(ViewModule, {}),
          sx: {
            bgcolor: "transparent",
            "&:hover": {
              bgcolor: "secondary"
      ...
      /* @__PURE__ */ jsx(
        Menu,
        {
          ...
          children: modules && modules.map((module2, index) => /* @__PURE__ */ jsx(
            MenuItem,
            {
              "data-value": module2.name,
              onClick: (e) => {
    ...
    /* @__PURE__ */ jsxs(Box, { children: [
      ...
      /* @__PURE__ */ jsx(
        Menu,
        {
          ...
          children: viewTypes && viewTypes.map((viewType, index) => /* @__PURE__ */ jsx(
            MenuItem,
            {
    ...
    /* @__PURE__ */ jsxs(Box, { children: [
      /* @__PURE__ */ jsx(
        Chip,
        {
          ...
          size: "small",
          "aria-controls": rowMenuOpen ? "basic-menu" : void 0,
          "aria-haspopup": "true",
          "aria-expanded": rowMenuOpen ? "true" : void 0,
          onClick: handleRowsMenuButtonClick,
          icon: /* @__PURE__ */ jsx(ViewStream, {}),
          sx: {
            bgcolor: "transparent",
            "&:hover": {
              bgcolor: "secondary"
      ...
      /* @__PURE__ */ jsx(
        Menu,
        {
          ...
          children: rowsOptionsMap && rowsOptionsMap.map((option, index) => /* @__PURE__ */ jsxs(
            MenuItem,
            {
              "data-value": option,
              onClick: (e) => {
    ...
    /* @__PURE__ */ jsx(Box, { children: /* @__PURE__ */ jsx(IconButton, { size: "small", children: /* @__PURE__ */ jsx(Visibility, {}) }) }),
    /* @__PURE__ */ jsx(Box, { children: /* @__PURE__ */ jsx(IconButton, { size: "small", children: /* @__PURE__ */ jsx(SaveOutlined, {}) }) })
  ] });
};
function Header({ drawerIsOpen }) {
  const { mode } = useThemeMode();
  const matchRoute = useMatchRoute();
  const isLayoutCreator = matchRoute({ to: "/layout_creator" });
  const logoContainerStyle = 200;
  return /* @__PURE__ */ jsx(AppBar, { position: "static", elevation: 0, sx: { bgcolor: "transparent" }, children: /* @__PURE__ */ jsxs(
    Toolbar,
    {
      sx: {
        gap: 2,
      ...
      children: [
        /* @__PURE__ */ jsx(Stack, { sx: { flexGrow: 1 }, display: "flex", children: /* @__PURE__ */ jsxs(Box, { display: "flex", alignItems: "center", gap: 2, children: [
          /* @__PURE__ */ jsx(Box, { sx: { width: logoContainerStyle }, children: /* @__PURE__ */ jsx(
            StyledCustomLink,
            {
              to: "/",
              variant: "h6",
              color: "text.primary",
              component: "div",
              children: "NaoFix Widget POC"
            }
          ) }),
          /* @__PURE__ */ jsx(Stack, { children: /* @__PURE__ */ jsxs(Box, { display: "flex", gap: 1, children: [
            /* @__PURE__ */ jsx(StyledCustomLink, { disabled: true, to: "/notavailable", children: "Messagerie" }),
            /* @__PURE__ */ jsx(StyledCustomLink, { disabled: true, to: "/notavailable", children: "Helpdesk" }),
            /* @__PURE__ */ jsx(StyledCustomLink, { disabled: true, to: "/notavailable", children: "Intervention" }),
            /* @__PURE__ */ jsx(StyledCustomLink, { disabled: true, to: "/notavailable", children: "Configuration" })
          ] }) })
        ] }) }),
        isLayoutCreator ? /* @__PURE__ */ jsx(CreatorPageToolComponent, {}) : /* @__PURE__ */ jsx(StyledCustomLink, { to: "/module_select", children: "Création de page" }),
        /* @__PURE__ */ jsx(IconButton, { onClick: toggleThemeMode, children: mode === "light" ? /* @__PURE__ */ jsx(Brightness4, {}) : /* @__PURE__ */ jsx(Brightness7, {}) })
      ]
    }
  ) });
}
...
function DefaultModal({
  ...
  const { borderRadius: borderRadius2 } = useThemeMode();
  const sizeMap = {
    xs: "xs",
    sm: "sm",
    md: "md",
  ...
  return /* @__PURE__ */ jsxs(
    Dialog,
    {
      ...
      fullWidth: true,
      sx: {
        borderRadius: radiusMap[borderRadius2]
      },
      maxWidth: sizeMap[size ?? "md"],
      children: [
        title && /* @__PURE__ */ jsx(DialogTitle, { id: "alert-dialog-title", children: title }),
        content && /* @__PURE__ */ jsx(DialogContent, { children: /* @__PURE__ */ jsx(DialogContentText, { id: "dialog-content", children: content }) }),
        actions && /* @__PURE__ */ jsx(DialogActions, { children: actions.map((action) => /* @__PURE__ */ jsx(Button, { onClick: action.onClick, children: action.label })) })
      ]
    }
  );
}
...
function TemplateLayoutModalTitle({
  ...
  return /* @__PURE__ */ jsxs(Box, { children: [
    ...
    /* @__PURE__ */ jsx(Typography, { variant: "body2", color: "text.secondary", children: currentType?.label })
  ] });
}
function TemplateLayoutModalContent({
  ...
  const [currentOrigin, setCurrentOrigin] = React__default.useState("software");
  const { borderRadius: borderRadius2 } = useThemeMode();
  const { close } = useModal("templateModal");
  const filteredTemplates = MockedTemplates.filter(
    (template) => template.origin === currentOrigin && template.module === module && template.view_type === viewType
  );
  ...
  return /* @__PURE__ */ jsxs(Stack, { spacing: 2, children: [
    /* @__PURE__ */ jsx(Box, { children: /* @__PURE__ */ jsx(
      Tabs,
      {
        ...
        variant: "scrollable",
        scrollButtons: "auto",
        children: MockedTemplatesCategories.map((viewType2) => /* @__PURE__ */ jsx(Tab, { value: viewType2.id, label: viewType2.label }, viewType2.id))
      }
    ) }),
    /* @__PURE__ */ jsx(Box, { children: filteredTemplates.length === 0 ? /* @__PURE__ */ jsx(Typography, { variant: "body2", color: "text.secondary", sx: { p: 2 }, children: "Aucun modèle disponible pour cette catégorie." }) : /* @__PURE__ */ jsx(Grid, { container: true, spacing: 2, children: filteredTemplates.map((template) => /* @__PURE__ */ jsx(Grid, { size: 3, children: /* @__PURE__ */ jsx(
      Card,
      {
        elevation: 0,
        sx: {
        ...
        children: /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(Typography, { variant: "h6", gutterBottom: true, children: template.name }) })
      }
    ) }, template.id)) }) })
  ] });
}
...
function Providers({ children }) {
  ...
  const { mode } = useThemeMode();
  return /* @__PURE__ */ jsx(CacheProvider, { value: emotionCache, children: /* @__PURE__ */ jsxs(ThemeProvider, { theme: getTheme(mode), children: [
...
function RootDocument({ children }) {
  ...
  return /* @__PURE__ */ jsxs("html", { children: [
    ...
    /* @__PURE__ */ jsxs("body", { style: { margin: 0 }, children: [
      /* @__PURE__ */ jsxs(Providers, { children: [
        /* @__PURE__ */ jsxs(DndContext, { onDragEnd: handleDragEnd, children: [
          /* @__PURE__ */ jsxs(
            Box,
            {
              sx: {
              ...
              children: [
                /* @__PURE__ */ jsx(Header, { drawerIsOpen }),
                ...
                /* @__PURE__ */ jsx(Box, { component: "footer", sx: { mt: "auto", py: 2 }, children: /* @__PURE__ */ jsx(
                  Typography,
                  {
                    variant: "body2",
                    color: "text.secondary",
                    textAlign: "center",
                    children: "©2025 NaoFix"
                  }
                ) })
              ]
            }
          ...
          /* @__PURE__ */ jsx(
            Drawer,
            {
              ...
              children: /* @__PURE__ */ jsxs(Box, { sx: { display: "flex", alignItems: "center", gap: 2 }, children: [
                ...
                /* @__PURE__ */ jsx(Typography, { variant: "h6", children: "Widgets" })
              ] })
            }
          )
        ] }),
...
const $$splitComponentImporter$3 = () => import("./notavailable-_XhTtZOU.js");
const Route$3 = createFileRoute("/notavailable")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./module_select-BFVQn7Sm.js");
const Route$2 = createFileRoute("/module_select")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./layout_creator-BEOx2mzK.js");
const Route$1 = createFileRoute("/layout_creator")({
  validateSearch: z.object({
    count: z.number().optional()
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-lxi_KskE.js");
const Route = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const NotavailableRoute = Route$3.update({
  id: "/notavailable",
  path: "/notavailable",
  getParentRoute: () => Route$4
});
const Module_selectRoute = Route$2.update({
  id: "/module_select",
  path: "/module_select",
  getParentRoute: () => Route$4
});
const Layout_creatorRoute = Route$1.update({
  id: "/layout_creator",
  path: "/layout_creator",
  getParentRoute: () => Route$4
});
...
export {
  ...
  Typography as T,
  CardContent as a,
  updateLayoutModule as b,
  createSvgIcon as c,
  darken as d,
  Chip as e,
  MenuItem as f,
  updateColumnWidth as g,
  useLayoutStore as h,
  updateLayoutColumns as i,
  router as j,
  lighten as l,
  modules as m,
  radiusMap as r,
